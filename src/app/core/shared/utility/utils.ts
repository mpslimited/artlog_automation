...
export class Utils {
    ...
    public static sortMultiPleArray(data: Array<any>, keys: Array<SumManupilations>) {
        ...
        mySortOrder.forEach((item) => {
            ...
            while ((ignoreIndex !== -1)) {
                ...
                ignoreIndex = currentTotalInArray.slice(previousIgnoreIndex + 1,
                    currentTotalInArray.length).findIndex(this.findFirstIngore);
    ...
    public static addRemoveObjIsAvailable(arr: Array<any>, obj: any, checkKey: string, task: 'add' | 'remove'): Array<any> {
